...
def Add_WCS_Header(file_name):
	...
	hdul[0].header=hdr
	del hdr['FLXSCALE']
	hdul.writeto('WCS_Added_'+file_name)	
''' 5 pic condition'''
...
'''           Change Header          '''
#write_ahead_file('Get_Rid_Of_Negative_PlateL20160919_04626_191658+1101_180S_S2_178390.FITS')



# HDUL_Add_Header('jg.fits')
# Add_WCS_Header('HDUL_Changed_jg.fits')
