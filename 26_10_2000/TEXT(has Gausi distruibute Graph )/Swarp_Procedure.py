...
#just_conv('IPHA/r414564-2.fits',FWHM_orign=2.8,FWHM_desinate=3.3)
# Conv_Image_With_Kernel_List_PSF_Model('IPHA','BAO/wz.fits')
# ISO_Calibrate_List('IPHAS_PSFex_Convolve','BAO/wz.fits')
# Reverse_Image_List('IPHAS_ISO_Cal')
# Swarp_Batch_Process('BAO/wz.fits','IPHAS_Reverse')

# ISO_Calibrate_List('IPHA','BAO/l2016.fits',index_l='FLUX')
# Conv_Image_With_Kernel_List_PSF_Model('IPHAS_ISO_Cal','BAO/l2016.fits')
# Reverse_Image_List('IPHAS_PSFex_Convolve')
# Swarp_Batch_Process('BAO/l2016.fits','IPHAS_Reverse')

ISO_Calibrate_List('IPHA','BAO/l2016.fits',index_l='FLUX')
FWHM_Calibrate_List_Sex('IPHAS_ISO_Cal','BAO/l2016.fits')
Reverse_Image_List('IPHAS_FWHM_Cal')
Swarp_Batch_Process('BAO/l2016.fits','IPHAS_Reverse')

# Conv_Image_With_Kernel_List_PSF_Model('IPHA','BAO/l2016.fits')
# ISO_Calibrate_List('IPHAS_PSFex_Convolve','BAO/l2016.fits',3.1)
# Reverse_Image_List('IPHAS_ISO_Cal')
# Swarp_Batch_Process('BAO/l2016.fits','IPHAS_Reverse')
...
# kernel_g=Gaussian2DKernel(4)
#Normalize_IPHAS_Fits_Header(file_name='r414564-2.fits')


#cut_image('astrometic software/sextractor/co_l2016.fits')
#cut_image('astrometic software/sextractor/ISO_cal_Cutted_r414564-2.fits')
#ISO_Calibrate('astrometic software/sextractor/r414564-2.fits',11.6125 ,11.3907)
#reverse_image('ISO_cal_WCS_Added_normal_r414564-2.fits')
#conv_image('Reversed_ISO_cal_r414564-2.fits',3.01,10)
#reverse_image('ISO_cal_r414564-2.fits')



#Pixel_Scale_Calibrate('astrometic software/sextractor/L20160919_04629_001901+6501_180S_S2_178471.fits',1.02875,0.33036)
# kernel_name=FWHM_Calibrate('astrometic software/sextractor/coadd.fits','astrometic software/sextractor/co_l2016.fits')


'''swarp'''

#kernel_name=FWHM_Calibrate('astrometic software/PSFEx/sex/r414564-2.fits','astrometic software/PSFEx/sex/l2016.fits')


#ISO_Calibrate('astrometic software/swarp/r414564-2.fits',11.3907-11.6125)
#reverse_image('astrometic software/swarp/ISO_Cal_r414564-2.fits')
#Pixel_Scale_Calibrate('astrometic software/swarp/L20160919_04629_001901+6501_180S_S2_178471.fits',1.02875,0.33036)
#Conv_Image_With_Kernel('astrometic software/swarp/Reversed_ISO_Cal_r414564-2.fits',kernel_name)

#just_conv('astrometic software/swarp/Reversed_ISO_Cal_r414564-2.fits',sigma=4,FWHM_orign=None,FWHM_desinate=None)

#Conv_Image_With_Kernel('IPHAS_Basis/r414564-2.fits',kernel_name)


#kernel_name=FWHM_Calibrate('astrometic software/PSFEx/sex/l2016.fits','astrometic software/PSFEx/sex/r414564-2.fits')
#Conv_Image_With_Kernel('astrometic software/PSFEx/temperor/l2016.fits',kernel_name)

'''batch proccesing with IPHA folder and BAO fits'''



# ISO_Calibrate_List('IPHAS','IPHAS_Basis/L20160919_04629_001901+6501_180S_S2_178471.fits')
# ###################################Pixel_Scale_Calibrate('astrometic software/swarp/L20160919_04629_001901+6501_180S_S2_178471.fits',1.02875,0.33036)
# Reverse_Image_List('IPHAS_ISO_Cal')
# Conv_Image_With_Kernel_List('IPHAS_Reverse',kernel_name)

# Swarp_Batch_Process('IPHAS_Basis/L20160919_04629_001901+6501_180S_S2_178471.fits','IPHAS_Convolve')


'''batch proccesing with IPHA folder and BAO folder'''

#Batch_Process('IPHAS_Basis','IPHAS')
